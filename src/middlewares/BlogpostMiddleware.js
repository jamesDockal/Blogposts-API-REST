...
var BlogpostMiddleware = /** @class */ (function () {
    function BlogpostMiddleware() {
    }
    // to created a post, you have to pass the necessary informations
    // that are title, content and slug
    BlogpostMiddleware.prototype.passedCrendentials = function (req, res, next) {
    ...
    BlogpostMiddleware.prototype.titleAlredyInUse = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var title, blogpostRepository, post;
    ...
    return BlogpostMiddleware;
}());
exports.default = BlogpostMiddleware;
